...
#ifndef LASTPLAYEDFILTER_H
#define LASTPLAYEDFILTER_H

#include "filter.h"


class LastPlayedFilter: public Filter
{
public:
    LastPlayedFilter(unsigned int limit, bool desc);
